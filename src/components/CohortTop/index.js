        ...
        <section class="text-gray-400 bg-gray-900 body-font overflow-hidden">
            <div class="container px-5 py-24 mx-auto">
                <div class="lg:w-4/5 mx-auto flex flex-wrap">
                    <img
                        alt="ecommerce"
                        class="lg:w-1/3 w-full w-200 lg:h-200 h-64 object-cover object-center rounded"
                    ...
                    <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div class="flex">
                            <button class="mt-5 text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-700 rounded">
